 <!-- Success Notification  -->
  ...
  <!-- Failure Notification  -->
    ...
    <section class="content">
        ...
        <div class="col-lg-12">
          ...
          <div class="box box-primary">
            <div class="box-header">
                            ...
                            <table class="table">
                              ...
                              <tbody>
                               <tr>
                                  ...
                                  <td><input type="text" name="rate[]" id="rate1" class="form-control" Placeholder="Enter price here ">
                                  ...
                                  <td><button type="button" class="btn btn-danger remove"><span class="fa fa-trash-o"></span> Remove</button type="button"></td>
                              </tr>
                              </tbody>
              ...
              <button type="button" class="btn btn-info add" ><span class="fa fa-plus"></span> Add Row</button type="button">   
              </div>
              <br><br>
      ...
      <div align="center">
        <button class="btn btn-success submit">Make Invoice</button>
      </div>
...
/*Ajax content fills */
     $('#item'+total+'').blur(function(){
      $.post('<?php echo site_url('products/get_contents');?>',{name:$('#item'+total+'').val()},function(res){
...
/*Submit ther form */
      ...
      for(var i=1;i<=$('#hide').val();i++)
    {
         ...
         if(rate=='')
        {
          ...
          $('#rate_valid'+i+'').html('<div><font color="red">Enter the Price</font><div>');
...
//item name for first row
    ...
    $('#item1').blur(function(){
      $.post('<?php echo site_url('products/get_contents');?>',{name:$("#item1").val()},function(res){
          var obj=jQuery.parseJSON(res);
          $('#rate1').val(obj.rate);
          $('#tax1').val(obj.tax);
          $('#quantity1').focus();
