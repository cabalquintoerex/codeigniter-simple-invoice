        ...
        <div class="col-lg-12">
          ...
          <div class="box box-primary">
            ...
            <div class="row box-body">
                <div class="col-lg-12">
                    <form id="filterinvoice" action="invoice_reports" class="form-inline" method="post">
                      <div class="form-group">                        
                      <label for="first_name">Date From</label>
                      <input type="date" class="form-control" id="date_from" name="date_from" value="<?php if(set_value('date_from')) echo set_value('date_from'); ?>">
                      </div>
                      <div class="form-group">
                      <label for="last_name">Date To</label>
                      <input type="date" class="form-control" id="date_to" name="date_to" value="<?php if(set_value('date_to')) echo set_value('date_to'); ?>">
                      </div>
